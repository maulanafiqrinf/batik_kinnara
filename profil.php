...
<body>
    ...
    <?php include 'pages/profil/breadcumb.php'; ?>
    <?php include 'pages/profil/hero.php'; ?>
    <?php
    $ctaType = isset($_GET['cta']) ? $_GET['cta'] : '1';
    if ($ctaType === '1') {
        include 'pages/profil/cta1.php';
    } else if ($ctaType === '2') {
        include 'pages/profil/cta2.php';
    }
    ?>
    <?php include 'pages/profil/testi.php'; ?>
