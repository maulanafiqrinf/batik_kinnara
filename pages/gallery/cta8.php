<section class="overflow-hidden space" data-bg-src="assets/img/bg/pattern_bg_7.png" id="galery">
    <div class="container">
            ...
            <div class="col-lg-auto">
                <div class="sec-btn mt-n3 mt-lg-0">
                    <div class="nav tab-menu1 indicator-active" id="tab-menu1" role="tablist">
                        ...
                        <button class="tab-btn" id="nav-6-tab" data-bs-toggle="tab" data-bs-target="#nav-6" type="button" role="tab" aria-controls="nav-6" aria-selected="false">
                        ...
                        <button class="tab-btn active" id="nav-8-tab" data-bs-toggle="tab" data-bs-target="#nav-8" type="button" role="tab" aria-controls="nav-8" aria-selected="false">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active " id="nav-8" role="tabpanel" aria-labelledby="nav-8-tab">
                <div class="slider-area">
                    <div class="row gy-30 overlay-direction">
