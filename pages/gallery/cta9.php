<section class="overflow-hidden space" data-bg-src="assets/img/bg/pattern_bg_7.png" id="galery">
    <div class="container">
            ...
            <div class="col-lg-auto">
                <div class="sec-btn mt-n3 mt-lg-0">
                    <div class="nav tab-menu1 indicator-active" id="tab-menu1" role="tablist">
                        ...
                        <button class="tab-btn active" id="nav-9-tab" data-bs-toggle="tab" data-bs-target="#nav-9" type="button" role="tab" aria-controls="nav-9" aria-selected="false">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="nav-9" role="tabpanel" aria-labelledby="nav-9-tab">
                <div class="slider-area">
                    <div class="row gy-30 overlay-direction">
